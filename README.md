...
- **求职意向**：后端 / 全栈开发实习生 🚀  
- **技术方向**：Go 后端 + React 前端，混合渲染架构探索 🖥️  
...
![Vue.js](https://img.shields.io/badge/Vue.js-4FC08D?style=flat-square&logo=vuedotjs&logoColor=white) ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white)  
- 熟悉 React / Next.js，理解 SSR / SPA 渲染与水合机制；了解 Vue.js
...
![Fiber](https://img.shields.io/badge/Fiber-00ACC1?style=flat-square&logo=go&logoColor=white) ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)  
- 熟悉 Go（Fiber / fasthttp）与 Java（Spring Boot），具备 RESTful API 设计与接口鉴权实践
...
- MySQL / Redis 使用与缓存设计；了解 Docker 容器化；GitHub Actions CI 实践
- LLM 应用集成（AI 内容审核）实战经验
...
| 项目名称 📚 | 描述 📝 | 技术栈 👨‍💻 |  
|--------------|---------|------------|  
| [ven-blog](https://github.com/RyaoVen/ven-blog) | 基于自研 VenHybird 框架的全栈博客产品，已上线（v1.1.1）：文章 / 动态 / 评论先审后发 / 留言板 / 点赞收藏 / 订阅搜索 / 后台面板 10+ 页面，AI 三态审核与 API Key 网关 | Go · React 19 · MySQL · Redis · LLM · GitHub Actions |  
| [VenHybird](https://github.com/RyaoVen/ven_hybird) | 自研开源混合渲染框架：Go 唯一公网入口（API / 鉴权 / ISR / 静态资源）+ Node 内部 SSR（React 19），事件驱动 ISR、SSE 实时推送、角色继承鉴权、Redis 集群可选 | Go · Node.js · React 19 · TypeScript · esbuild · Redis · SSE |  
